...
const LogUpdateRandomRender = (record) => {
    return <div className='custom-column--wrapper'>
        <input type='radio' id={record.txHash + record.eventLog + record.ID} name='toggle' />
        <label className='show-more-button' htmlFor={record.txHash + record.eventLog + record.ID}>More Info</label>
