const messages = {
    ...
    'Title.switchNetwork': '⚙  切换网络',
    'Networks.Ethereum': '以太坊',
    'Networks.BSC': '币安智能链',
    ...
    'Node.inactive': '离线',
    'Node.Unregister': '注销',
    'Events.Loading': '{type, select, approve {批准} withdraw {提取} claimreward {提取奖励} unregister {注销} updateNode {更新节点} unbond {赎回} delegate {委托质押} newNode {新建节点}}: https://cn.etherscan.com/tx/{hash}',
    'Events.Success': '{type, select, approve {批准} withdraw {提取} claimreward {提取奖励} unregister {注销} updateNode {更新节点} unbond {赎回} delegate {委托质押} newNode {新建节点}} 成功: 确认区块 {blockNumber}',
    ...
    'Form.Placeholder.InputLogoUrl': "请输入您节点Logo图像的Url网址",
    'Form.Lable.logoUrl': "节点Logo (选填，以http/https开头，推荐90 x 90像素的图)",
    'Form.Lable.UpdateLogoUrl': "更新节点Logo (推荐90 x 90像素的图)",
    /** NodeDetail**/
    ...
    'Tooltip.NodeDetail.UpdateNode': '更新节点',
